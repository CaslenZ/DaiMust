...
def translate_text():
    ...
    if selected_lang == "请选择目标语言":
        ...
        if 'trans_result' in result:
            ...
            translated_output.delete("1.0", tk.END)
            translated_output.insert(tk.END, "服务器连接错误，请联系开发人员或稍后再试！")


def show_about_dialog():
    messagebox.showinfo("关于此软件", "感谢使用由Tesret Studio提供的DaiMust系列软件。\n本软件支持自动检测全球160+通用语言并翻译主流语言。\n有任何问题，欢迎联系技术支持caslen08@icloud.com。\n Tesret Studio拥有此软件著作权。\n感谢Baidu API提供支持。")


window = tk.Tk()
window.title("DaiMust 翻译师")
window.geometry("550x450")  # 设置窗口大小为400x300
